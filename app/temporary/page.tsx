  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div
          className={`absolute top-[20%] left-[15%] w-[40rem] h-[30rem] bg-purple-600/20 rounded-full blur-[8rem] opacity-0 transition-opacity duration-1000 ${isLoaded ? "opacity-30" : ""}`}
        />
        <div
        ...
        <main className="flex-1 container mx-auto px-4 py-16 flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">
              Maaf, Projek Kami Sedang Dalam Work in Progress
            </h1>

            <div className="space-y-4 text-white/70 mb-8">
              <p className="text-lg">
                Saat ini kami sedang mengembangkan sistem pembelian dan pengelolaan layanan Novanodes.
              </p>
              <p>
                Sistem billing dan pembayaran akan diatur di website terpisah untuk keamanan dan kenyamanan pengguna.
                Kami akan memberitahu Anda segera setelah sistem siap digunakan.
              </p>
              <p>
                Terima kasih atas kesabaran dan dukungan Anda. Kami bekerja keras untuk memberikan layanan hosting
                terbaik untuk Anda.
              </p>
            </div>
